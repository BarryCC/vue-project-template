<template>
    <div class="center">
        <div class="center-data">
            <!--中间大圆-->
            <img class="center-bg-data" src="../../assets/images/center-bg-data.png" alt="大数据中心">
            <img :style="centerBgRotate" class="center-bg" src="../../assets/images/center-bg.png" alt="中间大圆">
            <!--线-->
...
<style scoped>
    .center{
        ...
        overflow: hidden;
        z-index: 0;
        background: url("../../assets/images/DataVisualization-bg.png") center;
    }
    .center-data{
        position: relative;
        width: 1150px;
